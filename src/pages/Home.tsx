...
import {
  ...
  ChevronRight, CheckCircle2, BarChart2, ClipboardCheck,
} from "lucide-react";
...
export default function Home() {
  ...
  // calendar preview: next 3 upcoming (by due date)
